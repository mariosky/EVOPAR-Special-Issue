...
\begin{abstract}
This work presents the EvoSpace model, a conceptual framework for the development of pool-based evolutionary algorithms. The EvoSpace model is built conceptually around a central repository or population store, incorporating some of the principles of the tuple-space model and adding additional features to tackle some of the issues associated with pool-based evolutionary algorithms: work redundancy, starvation of the population pool, unreliable workers, and parametrization. The model can serve as a platform to develop algorithms following an opportunistic approach to computing, allowing the exploitation of freely available services over the Internet or volunteer computing resources. A comprehensive analysis of the model at both the conceptual and implementation levels is provided. Particularly, the problems of lost connections and system parametrization are studied and validated experimentally, with encouraging results, that suggest how EvoSpace can be used to develop and implement different PEAs for search and optimization.    
