...
\begin{itemize}
	...
	\item Lost Work: when a participant does not return the result back to the server.
...
As stated earlier the EvoStore container incorporates some of the principles of the tuple-space model, an associatively addressed memory space shared by several processes. A tuple space can be described as a distributed shared memory (DSM) abstraction, organized as a \emph{bag} of tuples.
...
operation and $A_i$ as the output 
