...
\begin{figure*}[t]
    ...
    {
       \includegraphics[width=6cm]{Plot-Surface-Best-Run0-k5w4s64.eps}
       %\includegraphics[width=5cm]{Plot-Individuals-Eval-k4w32s32.eps}

    }
    \subfigure[Evaluated]
    {
        \includegraphics[width=6cm]{Plot-Individuals-Eval-k5w4s64.eps}
    }
    \\
    \subfigure[Experiment K]
    {
        \includegraphics[width=6cm]{DivMeanEvoSameScale.eps}
    }
    \subfigure[Standard GA]
    {
        \includegraphics[width=6cm]{DivMeanGASameScale.eps}
    }
    \caption{
...
\begin{figure*}[t]
    ...
    \subfigure[]
    {
        \includegraphics[width=6cm]{Evaluados.eps}
    }
    \subfigure[]
    {
        \includegraphics[width=6cm]{TimeBox.eps}
    }
    \caption{
...
\begin{figure*}[t]
    ...
    {
        \includegraphics[width=6cm]{plot_time_realtime.eps}
        \label{fig:plot_time_real}
    }
    \subfigure[Number of Evaluations]
    {
        \includegraphics[width=6cm]{plot_evals_realtime.eps}
        \label{fig:plot_evals_real}
    }\\
        \subfigure[Worker Costs]
    {
        \includegraphics[width=6cm]{plot_ges.eps}
        \label{plot_ges}
    }
...
\begin{figure*}[t]
    ...
    \subfigure[]
    {
        \includegraphics[width=6cm]{plot_time_CRS_w4.eps}
        \label{fig:plot_time_ri_w4}
    }
    \subfigure[]
    {
        \includegraphics[width=6cm]{plot_time_CRS_w8.eps}
        \label{fig:plot_time_ri_w8}
    }
    \subfigure[]
    {
        \includegraphics[width=6cm]{plot_time_CRS_w16.eps}
        \label{fig:plot_time_ri_w16}
    }
        \subfigure[]
    {
        \includegraphics[width=6cm]{16_plot_evals.eps}
        \label{fig:plot_evals_w16}
    }
        \subfigure[]
    {
        \includegraphics[width=6cm]{plot_percent_90.eps}
        \label{fig:plot_percent_90}
    }
        \subfigure[]
    {
        \includegraphics[width=6cm]{plot_percent_30.eps}
...
\begin{figure*}[t]
    ...
    \subfigure[]
    {
        \includegraphics[width=6cm]{Fitness-w16-30-random.eps}
        \label{fig:Fitness-w16-30-random}
    }
        \subfigure[]
    {
        \includegraphics[width=6cm]{Fitness-w16-30-reinsert.eps}
